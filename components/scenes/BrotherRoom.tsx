...
export default function BrotherRoom() {
  ...
  const handleGameComplete = () => {
    ...
    revealNumber('brother', roomNumber);
    ...
    >
      ...
      >
        ...
        >
          ...
          <img
            src={isRoomCompleted ? "/assets/brother/brother-final.webp" : "/assets/brother/brother.webp"}
            alt="Brother Room"
          ...
          {/* Clickable baby/tapestry area - center of image */}
          <motion.div
      ...
      {/* Tapestry Sliding Puzzle - Only show if not completed */}
      <AnimatePresence>
        {showGame && !isRoomCompleted && (
          <TapestrySlidingPuzzle
