...
export default function SisterRoom() {
  ...
  const isRoomCompleted = roomsCompleted.sister;
  ...
  const handleGameComplete = () => {
    ...
    completeRoom('sister');
    revealNumber('sister', roomNumber);
    ...
    >
      ...
      >
        ...
        >
          ...
          <img
            src={isRoomCompleted ? "/assets/sister/sister-final.webp" : "/assets/sister/sister.webp"}
            alt="Sister Room"
          ...
          {/* Clickable sisters area - center of image */}
          <motion.div
            onClick={handleSistersClick}
            className="group"
            style={{
              position: 'absolute',
              left: '25%',
          ...
          >
            ...
            <motion.div
              ...
              style={{
                ...
                borderRadius: '8px',
                boxShadow: '0 0 25px rgba(236, 72, 153, 0.5), 0 8px 32px rgba(0, 0, 0, 0.6)',
        ...
        {/* Right arrow - invisible for centering */}
        ...
        {showCard && (
          ...
          >
            ...
            >
              {/* Polaroid reward */}
              <img
                src="/assets/sister/polaroid.webp"
              ...
              />
              <p className="text-center text-pink-200 mt-4 text-sm" style={{ fontFamily: 'Georgia, serif' }}>
                ¡Recompensa desbloqueada! Click para cerrar
              </p>
            </motion.div>
          </motion.div>
        )}
